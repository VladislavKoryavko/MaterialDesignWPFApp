...
{
    public class VoltageDivider : DependencyObject
    {
        ...
        public VoltageDivider(byte forSend, string forView, float coefficientDivider, string axisTitle, float axisMinValue, float axisMaxValue, float axisStep)
        {
            ForSend = forSend;
            ForView = forView;
        ...
        public VoltageDivider(byte forSend, string forView, double coefficientDivider, string axisTitle, double axisMinValue, double axisMaxValue, double axisStep)
        {
            ForSend = forSend;
            ForView = forView;
